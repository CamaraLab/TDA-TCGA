...
#' @param mut_table mutation data from cohort in a table with headings Sample, Gene, Mutation, Type
...
#'
#' @return Returns a DriverMut_TDA object of nerve complexes computed across range of Mapper parameters.
#'
#' @import igraph
#' @import Matrix
#' @import ggplot2
